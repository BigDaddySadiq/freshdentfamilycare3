...
import { IMAGE_ASSETS, SERVICES, SERVICES_SECTION, SERVICE_DISCOVERY_SHORTCUTS } from '@/lib/clinic-data';
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {SERVICE_DISCOVERY_SHORTCUTS.map((shortcut) => (
              <TrackedLink
                ...
                className="inline-flex border border-navy/10 px-4 py-3 font-body text-[0.68rem] font-medium uppercase tracking-[0.15em] text-navy/75 transition-colors duration-300 hover:border-teal hover:bg-teal hover:text-white"
              >
                {shortcut.label}
              </TrackedLink>
            ))}
          ...
          {SERVICES.map((service) => {
            ...
            return (
              <motion.article
                ...
                className="group relative overflow-hidden border-t-2 border-t-transparent bg-white p-8 transition-[border-color,box-shadow,transform] duration-300 hover:border-t-teal hover:shadow-xl md:p-10"
              >
                <div className="relative z-10 flex h-full flex-col">
                  ...
                  <div className="mt-6 flex flex-wrap items-center gap-4">
                    <TrackedLink
                      ...
                      eventData={{ source: 'services-grid', treatment_intent: service.intentKey }}
                    ...
                    {service.detailHref ? (
                      <TrackedLink
                        ...
                        eventName={TRACKING_EVENTS.appointmentCtaClick}
                        eventData={{ source: 'services-grid', treatment_page: service.detailHref }}
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-4">
                ...
                <TrackedLink
                  ...
                  className="button-secondary border-navy/20 text-navy hover:border-navy hover:bg-navy hover:text-white"
                >
                  Request a Callback
                </TrackedLink>
              </div>
                ...
                <div className="mt-4 flex flex-wrap gap-3">
                  {SERVICE_DISCOVERY_SHORTCUTS.map((shortcut) => (
                    <TrackedLink
                      ...
                      className="inline-flex border border-navy/10 bg-white px-3 py-2 font-body text-[0.68rem] font-medium uppercase tracking-[0.14em] text-navy/75 transition-colors duration-300 hover:border-teal hover:text-navy"
                    >
